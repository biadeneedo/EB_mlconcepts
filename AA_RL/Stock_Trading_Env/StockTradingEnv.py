...
class StockTradingEnv(gym.Env):
    ...
    # %% PUT THE BOUNDARIES TO THE ENVIRONMENT   
    def __init__(self, df):
        super(StockTradingEnv, self).__init__()
        
        # Define the range of return
        self.df = df
    ...
    # %% TAKE AN ACTION + GO TO THE NEXT OBSERVATIONS
    # The function step includes the other two following functions (_take_action & _nest_observation)
    ...
    def _take_action(self, action):
        # Set the current price to a random price within the Open and the Close
        # price of the day connected to the current step
